...
export async function GET(request: NextRequest) {
  ...
  if (!clientId || !clientSecret) {
    return NextResponse.redirect(`${appBase()}/partners/dashboard/calendar?cal_error=microsoft_not_configured`)
  }
  ...
  return NextResponse.redirect(`${appBase()}/partners/dashboard/calendar?cal_connected=microsoft`)
}
