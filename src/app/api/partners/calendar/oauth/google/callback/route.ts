...
export async function GET(request: NextRequest) {
  ...
  if (!clientId || !clientSecret) {
    return NextResponse.redirect(`${calendarOAuthAppBase(request)}/partners/dashboard/calendar?calendar_error=google_not_configured`)
  }
  ...
  return NextResponse.redirect(`${calendarOAuthAppBase(request)}/partners/dashboard/calendar?calendar_connected=google`)
}
