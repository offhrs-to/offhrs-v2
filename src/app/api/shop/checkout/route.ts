    ...
    try {
      paymentIntent = await stripe.paymentIntents.create({
        ...
        metadata: {
          ...
          shippo_base_rate_cad: pricing.shippoBaseRateCad != null ? String(pricing.shippoBaseRateCad) : '',
          shipping_handling_fee_cad: String(pricing.handlingFeeCad),
          ...
          application_fee_cents: String(pricing.applicationFeeAmount),
